...
class TestMainApplication:
    ...
    def test_main_successful_execution(
        ...
        mock_load_components.return_value = (
            mock_splits, mock_index, mock_gemini_llm, mock_embedder, mock_gemini_model
        )
    ...
    @patch('main.load_dotenv')
    @patch('main.os.getenv')
    def test_main_missing_gemini_api_key(self, mock_getenv, mock_load_dotenv, mock_file):
        ...
        mock_print.assert_called_with("GEMINI_API_KEY not found in environment variables.")
    ...
    @patch('main.torch.cuda.is_available')
    @patch('main.os.path.exists')
    def test_main_cuda_not_available(self, mock_exists, mock_cuda, mock_getenv, mock_load_dotenv, mock_file):
