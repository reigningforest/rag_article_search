...
class TestRewriteNode:
    ...
    def test_rewrite_node_multiple_rewrites(self, mock_query_gemini):
        ...
        mock_query_gemini.return_value = "What is machine learning?\nDefine machine learning\nExplain ML concepts"
        ...
        # Verify
        expected_rewrites = ["What is machine learning?", "Define machine learning", "Explain ML concepts"]
...
class TestRetrieveNode:
    ...
    def test_retrieve_node_successful_retrieval(self):
        ...
        # Create node
        retrieve_node = create_retrieve_node(mock_splits, mock_index, mock_embedder, top_k=5)
...
class TestSimplifyAbstractsNode:
    ...
    def test_simplify_abstracts_node_execution(self, mock_query_gemini):
        ...
        # Create node
        simplify_node = create_simplify_abstracts_node(mock_gemini_model, simplification_prompt)
